...
namespace Whist.AIs
{
    public class GameAI : AI, IGameAI 
    {
        public GameAI(Player player, GameManager game): base(player, game){ }

        public virtual Card GetMove(IReferee referee) //TODO: use referee
        {
